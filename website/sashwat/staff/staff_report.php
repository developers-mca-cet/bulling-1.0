...
<li><a href="staff_report.php">Worker Wise</a></li>
  ...
  <br>
    ...
    <tr>
	  ...
	  <th>Fee type</th>
	  <th>Day</th>
	  <th rowspan="2"><button class="w3-button w3-black">SUBMIT</button></th>
    </tr>
    <tr>
      <td>
	  ...
	  <td>
		...
		<td><input class="w3-input w3-border" name="first" type="date"></td>
    </tr>
  </table>
    </div>
  </div>
  ...
  <div class="w3-card-4 " style="width:80%;">
    ...
    <div class="w3-container">
		<br>
		<p>Fee collected under @username.</p>
      <table class="w3-table w3-bordered">
    <tr>
      <th>Date & Time</th>
      <th>Name</th>
