    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="main_admin_view_staff.php">View Staff Details</a></li>
          <li><a href="main_admin_change_pword.php">Password Reset</a></li>
        </ul>
      </li>
...
<li><a href="#">Worker Wise</a></li>
  ...
  <div class="container-fluid text-center" style="height:550px">
